...
_아 저 개발자는 어떤 구조를 부서지지 않게, 바꾸지않으려 하지만, 어느정도의 구조는 부수고 바꾸려고 하는 개발자야!_
...
**시니어 개발자**는 한 프로젝트가 **치명적인 결함 방지와 일정한 구조 유지에 총력**을 다해야함.
...
**주니어 개발자**는 한 프로젝트에 **결함 발생 가능 부분을 찾고, 좀 더 발전할 수 있는 구조를 찾는데 총력**을 다해야함.
