...
**주니어 개발자**는 한 프로젝트개 **결함 발생 가능 부분을 찾고, 좀 더 발전할 수 있는 구조를 찾는데 총력**을 다해야함.
...
**내가 생각하는 `피트스탑`의 핵심은, `잠깐 멈추는 것`**, **그리고 `점검하는 것`**임.
...
**우리가 `잠깐 멈추는 것`**, 그리고 **`점검하는 것`**으로 **얻어 갈 수 있는건 아래**와 같음.
...
**그게 우리가 우물을 더 넓게, 더 깊게, 성장할 수 있는 방법**임.
...
기술 스택 공부나 사이드프로젝트, 휴식도 중요하지만,

<br>

다른 일들을 잠깐 멈추고, 지난 `KN` Project를 점검 해보았음.
